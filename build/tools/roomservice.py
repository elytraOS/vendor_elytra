...
org_display = "elytraOS"  # needed for displaying

default_manifest = ".repo/manifests/default.xml"
elytra_manifest = ".repo/manifests/wings/elytra.xml"
extra_manifest = ".repo/manifests/wings/extras.xml"
...
def add_to_manifest(repos, fallback_branch=None):
    ...
    elytram = load_manifest(elytra_manifest)
    extram = load_manifest(extra_manifest)
    ...
    for repo in repos:
        ...
        elif exists_in_tree(elytram, repo_path) != None:
             existing_m_project = exists_in_tree(elytram, repo_path)
        elif exists_in_tree(extram, repo_path) != None:
             existing_m_project = exists_in_tree(extram, repo_path)
