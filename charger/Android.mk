...
# Set elytra_charger_density to the density bucket of the device.
elytra_charger_density := mdpi
ifneq (,$(TARGET_SCREEN_DENSITY))
elytra_charger_density := $(strip \
...
elytra_charger_density := $(PRODUCT_AAPT_PREF_CONFIG)
endif

include $(CLEAR_VARS)
LOCAL_MODULE := elytra_charger_battery_scale
LOCAL_MODULE_STEM := battery_scale.png
LOCAL_SRC_FILES := $(elytra_charger_density)/battery_scale.png
...
include $(CLEAR_VARS)
LOCAL_MODULE := elytra_charger_battery_fail
LOCAL_MODULE_STEM := battery_fail.png
LOCAL_SRC_FILES := $(elytra_charger_density)/battery_fail.png
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_PATH := $(TARGET_OUT_PRODUCT_ETC)/res/images/charger
include $(BUILD_PREBUILT)
