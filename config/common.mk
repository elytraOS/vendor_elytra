...
# Elytra-specific init rc file
PRODUCT_COPY_FILES += \
    vendor/elytra/prebuilt/common/etc/init/init.elytra-system_ext.rc:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/init/init.elytra-system_ext.rc
...
PRODUCT_COPY_FILES += \
    vendor/elytra/prebuilt/common/etc/init/init.elytra-updater.rc:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/init/init.elytra-updater.rc
