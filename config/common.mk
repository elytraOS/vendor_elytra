...
# Backup Tool
PRODUCT_COPY_FILES += \
    vendor/elyta/prebuilt/common/bin/backuptool.sh:install/bin/backuptool.sh \
    vendor/elytra/prebuilt/common/bin/backuptool.functions:install/bin/backuptool.functions \
    vendor/elytra/prebuilt/common/bin/50-custom.sh:$(TARGET_COPY_OUT_SYSTEM)/addon.d/50-custom.sh
...
PRODUCT_COPY_FILES += \
    vendor/elytra/config/permissions/com.google.android.apps.dialer.call_recording_audio.features.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/permissions/com.google.android.apps.dialer.call_recording_audio.features.xml
endif
...
PRODUCT_COPY_FILES += \
    vendor/elytra/prebuilt/common/etc/sysconfig/pixel_2016_exclusive.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/sysconfig/pixel_2016_exclusive.xml

# Lineage-specific file
PRODUCT_COPY_FILES += \
    vendor/elytra/config/permissions/privapp-permissions-lineagehw.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/privapp-permissions-lineagehw.xml
...
PRODUCT_COPY_FILES += \
    vendor/elyta/prebuilt/common/etc/init/init.openssh.rc:$(TARGET_COPY_OUT_PRODUCT)/etc/init/init.openssh.rc
