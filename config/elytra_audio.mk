...
ALARM_PATH := vendor/elytra/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/elytra/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/elytra/prebuilt/common/media/audio/ringtones
